...
const featureBanner = document.querySelectorAll('#featureBanner');
const featureBannerGreen = document.querySelectorAll('#featureBannerGreen');


//features
const featuresContentTitle = document.querySelectorAll('.features-content h3');
const featuresContentP = document.querySelectorAll('.features-content p');
const featuresContentButton = document.querySelectorAll('.features-content .btn-row');
const featuresContentList = document.querySelectorAll(".features-list li");
